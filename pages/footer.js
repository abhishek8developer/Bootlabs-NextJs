          ...
          <div className="row">
            <div className="col-lg-6">
              <div className="footer-widget about_widget">
                ...
                <ul className="social-icon">
                  ...
                  <p>
                    <a href="mailto:sales@bootlabstech.com">
                      sales@bootlabstech.com
                    </a>
                  </p>
                </ul>
              </div>
            ...
            <div className="col-lg-2">
              <div className="footer-widget about_widget">
                ...
                <ul className="footer-nav">
                  <li>
                    <a href="/product" className="quicklink">
                      Sailor
                    </a>
                  </li>
                </ul>
            ...
            <div className="col-lg-2">
              <div className="footer-widget about_widget">
                ...
                <ul className="footer-nav">
                  ...
                  <li>
                    <a href="/contact" className="quicklink">
                      Blogs
                    </a>
                  </li>
                  <li>
                    <a href="/solutions" className="quicklink">
                      Services
                    </a>
                  </li>
                  <li>
                    <a href="/team" className="quicklink">
                      Team
                    </a>
                  </li>
                </ul>
            ...
            <div className="col-lg-2">
              <div className="footer-widget about_widget">
                ...
                <ul className="footer-nav">
                  <li>
                    <a href="/policies" className="quicklink">
                      Terms of Service
                    </a>
                  </li>
                  <li>
      ...
      <div className="copyright-area">
        <div className="container">
          <div className="row">
            ...
            <div className="col-lg-1 col-4">
              <a href="https://www.youtube.com/watch?v=-SjXUOL8-r0" target="_blank">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="30"
                  height="30"
            ...
            <div className="col-lg-1 col-4">
              <a href="https://in.linkedin.com/company/bootlabs-technologies" target="_blank">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="30"
                  height="30"
