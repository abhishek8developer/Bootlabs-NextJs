                  ...
                  <div className="content">
                    <div className='row'>
                      ...
                      <div className="col-10">
                        <h4 className="title text-left text-on-dark-bg">Cost Optimisation</h4>
                ...
                <div className="col-md-4">
                  <div className="content">
                    <div className='row'>
                      ...
                      <div className="col-10">
                        <h4 className="title text-left text-on-dark-bg">WAF Review</h4>
                ...
                <div className="col-md-4">
                  <div className="content">
                    <div className='row'>
                      ...
                      <div className="col-10">
                        <h4 className="title text-left text-on-dark-bg">Assessment</h4>
